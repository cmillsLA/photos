...
<title>Travel Photos | Berlin, Germany | by Chris Mills</title>
...
<div class="container">
	<div class="city">
      ...
      <a href="/berlin/" class="active">berlin</a>
    </div>
    <p>Photos start in Mitte, the city center of Berlin but also include other areas including former East Berlin.  Some specific neighborhoods other than Mitte include Kreuzberg-Friedrichshain and Friedrichshain.</p>
  </div>
  <div id="gallery">
			...
			<?php
				...
				//Echo out the images and their paths incased in an li.
				 for($x=0; $x < $totimg; $x++){
					 ...
					 //$width = $data[0];
					 //$height = $data[1];
					 $fullImgUrl = "http://photos.chrismills.me/img/berlin/full/" . $a_img[$x];
					 list($width, $height, $type, $attr) = getimagesize($fullImgUrl);
					 echo '<div class="img"><img src="' . $imgSrc . '" id="image_' . $x . '" /><a id="span_' . $x . '" href="/img/berlin/full/' . $a_img[$x] . '" data-imgW="' . $width . '" data-imgH="' . $height . '" rel="lightbox" class="lightbox"></a></div>';
				 }
			?>
     </div>
</div>
